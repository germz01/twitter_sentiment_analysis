...
\begin{document}
    ...
    \label{sec:classification}
        ...
        \label{sub:validation_routine}
            ...
            \begin{itemize}
                \item a word embedding learned during the training phase;
                \item the GloVe \cite{glove} pre-trained word vectors;
                \item the fastText \cite{fasttext} pre-trained word vectors;
            \end{itemize}
        ...
        \label{sub:positive_vs_negative_classification}
            ...
            a easier classification from the Machine Learning point of view. The application of the
            classification algorithms I mentioned earlier returns the following results:
